...
class Writing_On_GitHub_Cache_Test extends Writing_On_GitHub_TestCase {
	...
	public function test_should_set_and_fetch_commit_from_cache() {
		...
		set_transient( 'wogh_' . md5( 'commits_' . $this->sha ), $this->commit );
	...
	public function test_should_set_and_fetch_tree_from_cache() {
		...
		set_transient( 'wogh_' . md5( 'trees_' . $this->sha ), $this->tree );
	...
	public function test_should_set_and_fetch_blob_from_cache() {
		...
		set_transient( 'wogh_' . md5( 'blobs_' . $this->sha ), $this->blob );
