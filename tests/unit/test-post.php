...
class Writing_On_GitHub_Post_Test extends Writing_On_GitHub_TestCase {
	...
	public function test_should_return_correct_directory() {
		$post = new Writing_On_GitHub_Post( $this->id, $this->api );
	...
	public function test_should_export_unpublished_to_drafts_folder() {
		...
		$post = new Writing_On_GitHub_Post( $id, $this->api );
